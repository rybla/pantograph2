...
fromPropagDerivToDeriv :: forall d s. Tree (PropagLabel d s) -> Tree (DerivLabel d s)
...
propagateFixpoint :: forall d s. PrettyTreeLabel d => PrettyTreeLabel s => PropagRules d s -> Tree (PropagLabel d s) -> Tree (PropagLabel d s)
...
propagateOnce :: forall d s. PropagRules d s -> Path (PropagLabel d s) -> Tree (PropagLabel d s) -> Maybe (PropagRule d s /\ Tree (PropagLabel d s))
...
propagateOnce' :: forall d s. PropagRules d s -> Maybe (Tooth (PropagLabel d s)) -> Tree (PropagLabel d s) -> Maybe (PropagRule d s /\ Tree (PropagLabel d s))
